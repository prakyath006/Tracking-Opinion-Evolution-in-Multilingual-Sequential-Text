...
| mbert_sentence | in-domain | amazon | amazon | 0 | 0.5727 | 0.4837 | - | - | - | - |
| mbert_sentence | in-domain | dravidian_tamil | dravidian_tamil | 0 | 0.5219 | 0.4198 | - | - | - | - |
| textcnn | in-domain | amazon | amazon | - | 0.5391 | 0.4271 | - | - | - | - |
| textcnn | in-domain | dravidian_tamil | dravidian_tamil | - | 0.4032 | 0.3514 | - | - | - | - |
| xlmr_sentence | in-domain | amazon | amazon | 0 | 0.7800 | 0.6188 | - | - | - | - |
| xlmr_sentence | in-domain | dravidian_tamil | dravidian_tamil | 0 | 0.4256 | 0.3669 | - | - | - | - |
