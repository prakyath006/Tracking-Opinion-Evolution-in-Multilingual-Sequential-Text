...
| **Module 2: Encoder Backbone** | bert-base-multilingual-cased (0 layers trainable -- run used --freeze_encoder) | bert-base-multilingual-cased (all 12 layers trainable in the 2026-09-04 run; set --encoder_finetune_layers to match the full model) | xlm-roberta-base (SentencePiece 100-language model) | bert-base-multilingual-cased | bert-base-multilingual-cased | Randomly-initialised nn.Embedding (300d), learned from scratch -- no pretrained vectors |
